...
-R packages: "truncnorm", "ggplot2", "cowplot", "gridExtra", "minpack.lm", "nlsr" (2019 version), "iterators", "foreach", "doParallel", "dplyr".
...
<ul>
  ...
  <li> .zip files **MUST BE UNCOMPRESSED**, as they contain all the needed inputs for the code to work along with the required folder structure. Errors will be raised otherwise.</li>
